...
import V3Parceiros from "./pages/V3Parceiros";
...
import V3ProfileEdit from "./pages/V3ProfileEdit";
...
import V3Economize from "./pages/V3Economize";
import V3AIChat from "./pages/V3AIChat";
import V3Sobre from "./pages/V3Sobre";
import V3Contato from "./pages/V3Contato";
