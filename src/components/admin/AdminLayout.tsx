...
import { LayoutDashboard, Users, CalendarDays, Plus, ArrowLeft, LogOut, Lightbulb, ShieldCheck, MapPin, Globe, Instagram } from "lucide-react";
...
const navItems = [
  ...
  { to: "/admin/sugestoes", icon: Lightbulb, label: "Sugestões" },
