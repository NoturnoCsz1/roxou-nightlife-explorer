/**
 * PartnerAccessRequests — Fase 10A.
 *
 * Admin Roxou aprova / recusa pedidos de acesso ao Partner Pro.
 * Usa RPCs `approve_partner_access_request` e `reject_partner_access_request`.
 */
      ...
      <header className="flex flex-wrap items-center justify-between gap-2">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Aprovações criam vínculo `partner_users` (owner) + `partner_beta_access`.
          </p>
        </div>
              ...
              <div className="flex flex-wrap items-start justify-between gap-2">
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground truncate">
                    {[r.partner?.city, r.partner?.instagram]
                      .filter(Boolean)
                      .join(" · ")}
                  </p>
                </div>
